...
For non-english ASR, it is best to use the `large` whisper model. Alignment models are automatically picked by the chosen language from the default lists.
...
### French
    murmurai --model large --language fr examples/sample_fr_01.wav
...
### German
    murmurai --model large --language de examples/sample_de_01.wav
...
### Italian
    murmurai --model large --language de examples/sample_it_01.wav
...
### Japanese
    murmurai --model large --language ja examples/sample_ja_01.wav
